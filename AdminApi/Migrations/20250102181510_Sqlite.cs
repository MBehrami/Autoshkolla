    ...
    public partial class Sqlite : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 1, 3, 0, 15, 8, 697, DateTimeKind.Local).AddTicks(192), "Vue Admin is a single page admin template developed by Vue with .Net core 8 API. It’s covered most common features that you need to start a project.", true, true, null, null, "What are the purposes of this app?" },
                    { 2, 1, new DateTime(2025, 1, 3, 0, 15, 8, 697, DateTimeKind.Local).AddTicks(198), "The most amazing part of this template is, you have five popular Relational database connectivity options here. You have flexibility to choose Sql server, Mysql, Sqlite, PostgreSql and Oracle 12c+.", true, true, null, null, "Why this app differs from others?" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(7581), "mdi-menu", false, true, 1, null, null, "Menus", 0, 2, "" },
                    { 2, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(7589), "", false, true, 0, null, null, "All Menu", 1, 0, "/menu" },
                    { 3, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(7592), "", false, true, 0, null, null, "Menu Group", 1, 0, "/menu-group" },
                    { 4, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(7595), "mdi-account", false, true, 1, null, null, "Users", 0, 3, "" },
                    { 5, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(7597), "", false, true, 0, null, null, "All User", 4, 0, "/users" },
                    { 6, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(7599), "", false, true, 0, null, null, "Roles", 4, 0, "/user-role" },
                    { 7, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(7602), "mdi-history", false, true, 1, null, null, "Logs", 0, 4, "" },
                    { 8, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(7604), "", false, true, 0, null, null, "Browsing Log", 7, 0, "/browse-log" },
                    { 9, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(7607), "", false, true, 0, null, null, "Error Log", 7, 0, "/error-log" },
                    { 10, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(7609), "mdi-home", true, true, 0, null, null, "Dashboard", 0, 1, "/dashboard" },
                    { 11, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(7612), "mdi-frequently-asked-questions", false, true, 0, null, null, "FAQ", 0, 5, "/faq" },
                    { 12, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(7614), "mdi-contacts", false, true, 0, null, null, "Contact", 0, 6, "/contact" },
                    { 13, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(7616), "mdi-cog", false, true, 0, null, null, "App Settings", 0, 7, "/settings" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(3490), true, true, null, null, "Super Admin Group" },
                    { 2, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(3507), true, true, null, null, "User Group" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(8656), true, true, 1, 2 },
                    { 2, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(8663), true, true, 1, 3 },
                    { 3, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(8667), true, true, 1, 5 },
                    { 4, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(8669), true, true, 1, 6 },
                    { 5, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(8671), true, true, 1, 8 },
                    { 6, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(8673), true, true, 1, 9 },
                    { 7, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(8675), true, true, 1, 10 },
                    { 8, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(8676), true, true, 1, 11 },
                    { 9, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(8678), true, true, 1, 12 },
                    { 10, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(8681), true, true, 1, 13 },
                    { 11, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(8682), true, true, 2, 10 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(4424), true, true, null, null, 1, null, "Admin" },
                    { 2, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(4429), true, true, null, null, 2, null, "User" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(6083), null, "admin@vueadmin.com", null, "John Doe", null, true, true, false, null, null, null, null, "c7JZ+u1vrHp/FQqdD69JQhBTDoLnCNba6dqVyKpEXu4=", null, "3fdcuIxZk3sdxmjJPM0FuA==", 1 },
                    { 2, 1, new DateTime(2025, 1, 3, 0, 15, 8, 696, DateTimeKind.Local).AddTicks(6091), null, "user@vueadmin.com", null, "Helen Smith", null, true, true, false, null, null, null, null, "AJNri22q/JA3fbO4m0QIRYxEChegS461t7J1f7C/td8=", null, "gLtMyAEbVeLjZGj312VXyg==", 2 }
                });
        }
